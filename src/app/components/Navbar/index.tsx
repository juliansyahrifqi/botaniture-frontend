    ...
    <>
      ...
      {sidebarOpen && (
        <div className="z-50">
          ...
          <nav className="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm pt-12 pb-4 px-10 bg-sidebar border-r overflow-y-auto">
              ...
              <ul>
                <li className="mb-2">
                  <Link
                    ...
                    } block p-4 text-lg font-semibold text-primary hover:bg-primary-20 hover:text-primary`}
                    href="/"
                  >
                    Beranda
                  </Link>
